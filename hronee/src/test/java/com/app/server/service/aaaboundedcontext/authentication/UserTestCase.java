...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        useraccesslevel.setLevelName("5aSCbw7ctgwHZZMYjzlWIu5jUPwlbMaNjoxdhhlECWgfyiCRLl");
        useraccesslevel.setUserAccessLevel(valueGenerator.getRandomInteger(99999, 0));
        useraccesslevel.setLevelHelp("YhuExu3yUF6kAnwUTX4bG09wmL15nf1lFGN5o1YAbdt9lcX0J7");
        useraccesslevel.setLevelIcon("lZj67qggbytq1qJTLJSFM21D2yfU3iroA12fthmWYLI5j1x7qG");
        useraccesslevel.setLevelDescription("vLWorbC1vEQSDEf7r8Uiuwz42FD8VawSezw7TQEOjKDwsqQ1PV");
        ...
        useraccessdomain.setDomainIcon("51MIkgui07YAfevbF0JkAEJI4HcIIwQ46xE7L1vLleaKK5iLIh");
        useraccessdomain.setDomainDescription("vnuFC4u4Z7PN4lKBwiN1RjWtyxjqXvZP2MP0iJDlZ2IC4KsF6S");
        useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
        useraccessdomain.setDomainHelp("yTYQreRISUnBZLtDrPLx2Yc6yjIoba1g0FguAE1gtAKbZBFPmM");
        useraccessdomain.setDomainName("nNCZktjlAy6C7PNxNNQuOAUOGqkzumaAB5zelmTjN2FvwYjds3");
        ...
        user.setSessionTimeout(2576);
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setMultiFactorAuthEnabled(1);
        user.setAllowMultipleLogin(1);
        user.setPasswordAlgo("kAstxe0tRmzzxwvqUHVW9Z3VFsL8eVSYUWRIMnaKxEZsRUhEwH");
        user.setPasswordExpiryDate(new java.sql.Timestamp(1460532730181l));
        user.setIsDeleted(1);
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1460532730181l));
        user.setIsLocked(1);
        user.setGenTempOneTimePassword(1);
        user.setUserAccessCode(31430);
        java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
        PassRecovery passrecovery = new PassRecovery();
        Question question = new Question();
        question.setQuestionIcon("AQThiyBsFs6fEiC4tGEuTKRw6QFY8wqMu2r7ZLU8PgARiQzWgl");
        question.setLevelid(1);
        question.setQuestion("rDBdBNJ01NWONrTcb6CrHapdQxw3tCwk9SeHCzbFlbJuB3JtJJ");
        question.setQuestionDetails("7S0cEvMfMl");
        ...
        passrecovery.setAnswer("fL9R14WL5fI6vYcKnYcadaUC2h7JOPDJIPOrFB1XAN7ebrbH9j");
        listOfPassRecovery.add(passrecovery);
        user.addAllPassRecovery(listOfPassRecovery);
        UserData userdata = new UserData();
        userdata.setOneTimePassword("qQwdetAusH4tkzInjifDkY4AX0iNajvh");
        userdata.setLast5Passwords("BkoBviZfUmjuqwgGAPHBzUPTc3YaIJnaUa3O93CdO6hEReH8Kw");
        userdata.setOneTimePasswordExpiry(4);
        userdata.setPassword("BsBxsYHG94pspQ4ScqTZsBtrMrfaO48FjgqFdVVAxmboSE9fAD");
        userdata.setOneTimePassword("54sNTy68OMESShVzOEwJg8a6Aeaf62T1");
        userdata.setLast5Passwords("vq4l0RPEfu4bdKMSeCI5rqemzFmxBaQ8U2fGlYGTWuzKyoUDGb");
        userdata.setOneTimePasswordExpiry(8);
        userdata.setPassword("V3XninrXxKDBviU4KxCw3tvmJhSGFBmfOOuhOwZoQvrMQRr93A");
        userdata.setUser(user);
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1460532730516l));
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 75089));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "lKcpbQpgzvTuWoZPhvUPLCVpcJ3VSDZJCm1tGqUKofyIB1qEpfSuwBRoVd1yna730"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 4917));
