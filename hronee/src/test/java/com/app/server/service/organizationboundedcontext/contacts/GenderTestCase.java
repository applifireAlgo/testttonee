...
public class GenderTestCase extends EntityTestCriteria {
    ...
    private Gender createGender(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        gender.setGender("tpSAmkkQ5bYSuCdWRbM7r7k4KG9kWZc0Grym0dKglxoZmZPRQK");
    ...
    public void test2Update() {
        try {
            ...
            gender.setGender("ZChaXxUOFHlyO5KONPVbwko4p3TQRJVwh928eS4bxW6zyzuQhf");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "gender", ""));
