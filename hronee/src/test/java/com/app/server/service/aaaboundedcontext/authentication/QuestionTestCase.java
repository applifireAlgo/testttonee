...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        question.setQuestionIcon("2wE4sBVZsSJdmFFFX2Sty3R3Ri8yzKnGICS2Cz64MQnjetOpJ4");
        question.setLevelid(8);
        question.setQuestion("ty2RwMjoj54hGpNdsUgk3jByjerFNsyNR5bNqFnFGSdgGxVPs1");
        question.setQuestionDetails("zKI0ywu6Ar");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionIcon("NbTnIp6Og5KKnd5nputfn2Z8N41Cn2RFACBXY3FOiCmvxXPWT3");
            question.setVersionId(1);
            question.setLevelid(4);
            question.setQuestion("WZ0OEgfDf1kBUUYdOEB8LqUUdWCoVTlNDLNjXDNttwzK1bgenO");
            question.setQuestionDetails("xhsEKMs4iT");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "Qm3iwdfuFlId8YttpcZWUjqyUyAScCFDtHSBH8t5Ir4F4YIMoDOZBttqkqCBmtCIe"));
