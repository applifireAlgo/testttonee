Ext.define("Hronee.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Hronee.view.clouddrive.CloudDriveController',
	             'Hronee.view.clouddrive.documentview.DocumentsView',
	             'Hronee.view.clouddrive.drivedetails.DriveDetails',
	             //'Hronee.view.clouddrive.documentview.DocumentListView'
	             ],
