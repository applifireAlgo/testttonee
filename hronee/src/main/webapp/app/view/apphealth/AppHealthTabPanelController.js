 ...
 * 
 */
Ext.define('Hronee.view.apphealth.AppHealthTabPanelController',{
	extend : 'Ext.app.ViewController',
	alias : 'controller.appHealthTabPanelController',
	requires : ['Hronee.view.apphealth.AppHealthConnector'],
						...
						success : function(response, opts){
							...
							if (responseJson.response.success) {
								...
								for(var i = 0; i < appHealthSchedulerData.length; i++)
								{
									...
									var connectorPanel = Ext.create("Hronee.view.apphealth.AppHealthConnector", {
