 ...
 * 
 */
Ext.define('Hronee.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Hronee.view.logalarm.mainscreen.AddLogAlarmController',
			'Hronee.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Hronee.view.logalarm.mainscreen.AppAlarmPanel',
