 ...
 * 
 */
Ext.define('Hronee.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Hronee.view.logalarm.LogAlarmMainViewController',
			'Hronee.view.logalarm.tree.LogAlarmTreePanel',
			'Hronee.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
