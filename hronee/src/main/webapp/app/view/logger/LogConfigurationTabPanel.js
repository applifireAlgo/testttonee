...
Ext
		.define(
				'Hronee.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Hronee.view.logger.tabs.details.DetailsTab',
							'Hronee.view.logger.tabs.fileconnector.FileConnectorTab',
							'Hronee.view.logger.tabs.dbconnector.DBConnectorTab',
							'Hronee.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Hronee.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Hronee.view.logger.LogConfigurationTabPanelController',
