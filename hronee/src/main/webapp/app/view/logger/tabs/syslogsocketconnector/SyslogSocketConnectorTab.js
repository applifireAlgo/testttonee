 ...
 * 
 */
Ext.define('Hronee.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Hronee.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
