Ext
		.define(
				'Hronee.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Hronee.view.searchengine.search.SearchEngineMainPanelController','Hronee.view.searchengine.search.PanelHeaderField' ,'Hronee.view.searchengine.search.ReportGridView','Hronee.view.searchengine.search.ReportChartView','Hronee.view.searchengine.search.documentView','Hronee.view.searchengine.search.DouMeanView','Hronee.view.googlemaps.map.MapPanel'],
