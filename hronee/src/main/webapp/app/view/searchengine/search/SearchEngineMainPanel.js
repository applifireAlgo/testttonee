Ext.define('Hronee.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Hronee.view.searchengine.search.NorthPanel', 'Hronee.view.searchengine.search.SearchResult','Hronee.view.searchengine.search.SearchEngineMainPanelController'],
