Ext.define('Hronee.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Hronee.view.usermanagement.admin.UserPasswordReset',
	            'Hronee.view.usermanagement.admin.AddUserDetails',
	            'Hronee.view.usermanagement.admin.ViewUser'],
