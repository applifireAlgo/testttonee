 ...
 * 
 */
Ext.define('Hronee.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Hronee.view.securityconfig.SecurityConfigController',
			'Hronee.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
