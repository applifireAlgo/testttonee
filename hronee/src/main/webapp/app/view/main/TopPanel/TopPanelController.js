Ext.define('Hronee.view.main.TopPanel.TopPanelController', {
	...
	onSearchClick : function(button) {
		...
		//	"Hronee.view.scheduler.scheduler"
		var component = Ext.create(
				"Hronee.view.searchengine.search.SearchEngineMainPanel", {
					closable : true,
					title : "Search Engine",
					refId : "-1"
				});
	...
	{
		var component = Ext.create(
				"Hronee.view.clouddrive.CloudDrive", {
					closable : true,
					title : "Cloud Drive",
					//refId : "-1"
				});
