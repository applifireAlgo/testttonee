...
public class SalStrucFinWiseServiceImpl extends SalStrucFinWiseService {
    ...
    public HttpEntity<ResponseBean> findAll() throws SpartanPersistenceException, Exception {
        ...
        java.util.List<com.app.shared.humanresourceboundedcontext.payroll.SalStrucFinWise> lstsalstrucfinwise = salStrucFinWiserepo.findAll();
    ...
    private Map<String, String> getFieldMetaData() {
        ...
        fieldMetaData.put("salaryDrawn", "double");
        fieldMetaData.put("taxableAmount", "double");
        fieldMetaData.put("nonTaxableAmount", "double");
    ...
    public HttpEntity<ResponseBean> findByEmpId(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            List<com.app.shared.humanresourceboundedcontext.payroll.SalStrucFinWise> lstsalstrucfinwise = salStrucFinWiserepo.findByEmpId((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstsalstrucfinwise);
        } catch (org.springframework.transaction.TransactionException e) {
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            com.app.shared.humanresourceboundedcontext.payroll.SalStrucFinWise lstsalstrucfinwise = salStrucFinWiserepo.findById((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstsalstrucfinwise);
        } catch (org.springframework.transaction.TransactionException e) {
