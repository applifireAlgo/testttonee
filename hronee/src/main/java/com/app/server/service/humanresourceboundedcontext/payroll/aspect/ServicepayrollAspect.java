package com.app.server.service.humanresourceboundedcontext.payroll.aspect;
...
public class ServicepayrollAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* com.app.server.service.humanresourceboundedcontext.payroll..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.app.server.service.humanresourceboundedcontext.payroll..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.app.server.service.humanresourceboundedcontext.payroll..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.app.server.service.humanresourceboundedcontext.payroll..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.app.server.service.humanresourceboundedcontext.payroll..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.app.server.service.humanresourceboundedcontext.payroll..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
