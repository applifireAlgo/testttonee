...
public class AttendenceSummaryServiceImpl extends AttendenceSummaryService {
    ...
    public HttpEntity<ResponseBean> findAll() throws SpartanPersistenceException, Exception {
        ...
        java.util.List<com.app.shared.humanresourceboundedcontext.attendance.AttendenceSummary> lstattendencesummary = attendenceSummaryrepo.findAll();
    ...
    private Map<String, String> getFieldMetaData() {
        ...
        fieldMetaData.put("monthValue", "integer");
        fieldMetaData.put("present", "integer");
        fieldMetaData.put("absent", "integer");
        fieldMetaData.put("privilegeLeave", "integer");
        fieldMetaData.put("casualLeave", "integer");
        fieldMetaData.put("sickLeave", "integer");
        fieldMetaData.put("maternityLeave", "integer");
    ...
    public HttpEntity<ResponseBean> findByEmpId(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            List<com.app.shared.humanresourceboundedcontext.attendance.AttendenceSummary> lstattendencesummary = attendenceSummaryrepo.findByEmpId((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstattendencesummary);
        } catch (org.springframework.transaction.TransactionException e) {
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            com.app.shared.humanresourceboundedcontext.attendance.AttendenceSummary lstattendencesummary = attendenceSummaryrepo.findById((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstattendencesummary);
        } catch (org.springframework.transaction.TransactionException e) {
