package com.app.server.service.humanresourceboundedcontext.employee.aspect;
...
public class ServiceemployeeAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* com.app.server.service.humanresourceboundedcontext.employee..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.app.server.service.humanresourceboundedcontext.employee..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.app.server.service.humanresourceboundedcontext.employee..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.app.server.service.humanresourceboundedcontext.employee..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.app.server.service.humanresourceboundedcontext.employee..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.app.server.service.humanresourceboundedcontext.employee..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
