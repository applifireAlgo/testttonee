...
@RestController
@SourceCodeAuthorClass(createdBy = "anagha.kulkarni@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Service for DesignationType Master table Entity", complexity = Complexity.LOW)
...
public class DesignationTypeServiceImpl extends DesignationTypeService {
    ...
    public HttpEntity<ResponseBean> findAll() throws SpartanPersistenceException, Exception {
        ...
        java.util.List<com.app.shared.humanresourceboundedcontext.employee.DesignationType> lstdesignationtype = designationTyperepo.findAll();
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            com.app.shared.humanresourceboundedcontext.employee.DesignationType lstdesignationtype = designationTyperepo.findById((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstdesignationtype);
        } catch (org.springframework.transaction.TransactionException e) {
