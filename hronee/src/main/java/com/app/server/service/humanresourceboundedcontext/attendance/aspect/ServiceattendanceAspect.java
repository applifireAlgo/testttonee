package com.app.server.service.humanresourceboundedcontext.attendance.aspect;
...
public class ServiceattendanceAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* com.app.server.service.humanresourceboundedcontext.attendance..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.app.server.service.humanresourceboundedcontext.attendance..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.app.server.service.humanresourceboundedcontext.attendance..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.app.server.service.humanresourceboundedcontext.attendance..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.app.server.service.humanresourceboundedcontext.attendance..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.app.server.service.humanresourceboundedcontext.attendance..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
