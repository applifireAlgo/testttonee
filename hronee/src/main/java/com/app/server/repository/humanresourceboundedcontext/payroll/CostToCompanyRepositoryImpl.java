...
@Repository
@SourceCodeAuthorClass(createdBy = "anagha.kulkarni@algorhythm.co.in", updatedBy = "anagha.kulkarni@algorhythm.co.in", versionNumber = "2", comments = "Repository for CostToCompany Transaction table", complexity = Complexity.MEDIUM)
public class CostToCompanyRepositoryImpl extends SearchInterfaceImpl implements CostToCompanyRepository<CostToCompany> {
    ...
    public List<CostToCompany> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.humanresourceboundedcontext.payroll.CostToCompany> query = emanager.createQuery("select u from CostToCompany u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<CostToCompany> save(List<CostToCompany> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.humanresourceboundedcontext.payroll.CostToCompany obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.humanresourceboundedcontext.payroll.CostToCompany s = emanager.find(com.app.shared.humanresourceboundedcontext.payroll.CostToCompany.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<CostToCompany> findByEmpId(String empId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.humanresourceboundedcontext.payroll.CostToCompany> listOfCostToCompany = query.getResultList();
    ...
    public CostToCompany findById(String salaryId) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.humanresourceboundedcontext.payroll.CostToCompany listOfCostToCompany = (com.app.shared.humanresourceboundedcontext.payroll.CostToCompany) query.getSingleResult();
            return listOfCostToCompany;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
