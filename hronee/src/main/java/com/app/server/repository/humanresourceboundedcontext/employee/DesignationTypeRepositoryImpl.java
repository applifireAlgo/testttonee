...
@Repository
@SourceCodeAuthorClass(createdBy = "anagha.kulkarni@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for DesignationType Master table Entity", complexity = Complexity.LOW)
public class DesignationTypeRepositoryImpl extends SearchInterfaceImpl implements DesignationTypeRepository<DesignationType> {
    ...
    public List<DesignationType> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.humanresourceboundedcontext.employee.DesignationType> query = emanager.createQuery("select u from DesignationType u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<DesignationType> save(List<DesignationType> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.humanresourceboundedcontext.employee.DesignationType obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.humanresourceboundedcontext.employee.DesignationType s = emanager.find(com.app.shared.humanresourceboundedcontext.employee.DesignationType.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public DesignationType findById(String designatnTypeCode) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.humanresourceboundedcontext.employee.DesignationType listOfDesignationType = (com.app.shared.humanresourceboundedcontext.employee.DesignationType) query.getSingleResult();
