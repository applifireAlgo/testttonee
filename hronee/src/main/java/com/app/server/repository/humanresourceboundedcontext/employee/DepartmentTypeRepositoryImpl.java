...
@Repository
@SourceCodeAuthorClass(createdBy = "anagha.kulkarni@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for DepartmentType Master table Entity", complexity = Complexity.LOW)
public class DepartmentTypeRepositoryImpl extends SearchInterfaceImpl implements DepartmentTypeRepository<DepartmentType> {
    ...
    public List<DepartmentType> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.humanresourceboundedcontext.employee.DepartmentType> query = emanager.createQuery("select u from DepartmentType u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<DepartmentType> save(List<DepartmentType> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.humanresourceboundedcontext.employee.DepartmentType obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.humanresourceboundedcontext.employee.DepartmentType s = emanager.find(com.app.shared.humanresourceboundedcontext.employee.DepartmentType.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public DepartmentType findById(String deptTypeCode) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.humanresourceboundedcontext.employee.DepartmentType listOfDepartmentType = (com.app.shared.humanresourceboundedcontext.employee.DepartmentType) query.getSingleResult();
