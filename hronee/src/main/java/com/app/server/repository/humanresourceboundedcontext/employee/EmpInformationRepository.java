...
public interface EmpInformationRepository<T> extends SearchInterface {
    ...
    public List<T> findByDesignationTypeCode(String designationTypeCode) throws Exception, SpartanPersistenceException;

    public List<T> findByJobTypeCode(String jobTypeCode) throws Exception, SpartanPersistenceException;
