package com.app.server.repository.humanresourceboundedcontext.payroll;
...
@Repository
@SourceCodeAuthorClass(createdBy = "anagha.kulkarni@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for SalStrucFinWise Transaction table", complexity = Complexity.MEDIUM)
public class SalStrucFinWiseRepositoryImpl extends SearchInterfaceImpl implements SalStrucFinWiseRepository<SalStrucFinWise> {
    ...
    public List<SalStrucFinWise> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.humanresourceboundedcontext.payroll.SalStrucFinWise> query = emanager.createQuery("select u from SalStrucFinWise u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<SalStrucFinWise> save(List<SalStrucFinWise> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.humanresourceboundedcontext.payroll.SalStrucFinWise obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.humanresourceboundedcontext.payroll.SalStrucFinWise s = emanager.find(com.app.shared.humanresourceboundedcontext.payroll.SalStrucFinWise.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<SalStrucFinWise> findByEmpId(String empId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.humanresourceboundedcontext.payroll.SalStrucFinWise> listOfSalStrucFinWise = query.getResultList();
    ...
    @Transactional
    public SalStrucFinWise findById(String applicantId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("SalStrucFinWise.findById");
            query.setParameter("applicantId", applicantId);
            com.app.shared.humanresourceboundedcontext.payroll.SalStrucFinWise listOfSalStrucFinWise = (com.app.shared.humanresourceboundedcontext.payroll.SalStrucFinWise) query.getSingleResult();
            return listOfSalStrucFinWise;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
