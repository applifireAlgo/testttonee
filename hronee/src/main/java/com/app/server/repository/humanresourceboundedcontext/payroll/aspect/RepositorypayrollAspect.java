package com.app.server.repository.humanresourceboundedcontext.payroll.aspect;
...
public class RepositorypayrollAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* com.app.server.repository.humanresourceboundedcontext.payroll..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.humanresourceboundedcontext.payroll..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.humanresourceboundedcontext.payroll..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.humanresourceboundedcontext.payroll..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.humanresourceboundedcontext.payroll..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.humanresourceboundedcontext.payroll..*(..))")
