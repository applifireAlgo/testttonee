package com.app.server.repository.humanresourceboundedcontext.employee.aspect;
...
public class RepositoryemployeeAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* com.app.server.repository.humanresourceboundedcontext.employee..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.humanresourceboundedcontext.employee..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.humanresourceboundedcontext.employee..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.humanresourceboundedcontext.employee..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.humanresourceboundedcontext.employee..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.humanresourceboundedcontext.employee..*(..))")
