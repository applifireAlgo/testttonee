package com.app.server.repository.humanresourceboundedcontext.attendance.aspect;
...
public class RepositoryattendanceAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* com.app.server.repository.humanresourceboundedcontext.attendance..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.humanresourceboundedcontext.attendance..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.humanresourceboundedcontext.attendance..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.humanresourceboundedcontext.attendance..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.humanresourceboundedcontext.attendance..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.humanresourceboundedcontext.attendance..*(..))")
