package com.app.server.repository.humanresourceboundedcontext.attendance;
...
@Repository
@SourceCodeAuthorClass(createdBy = "anagha.kulkarni@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for AttendenceSummary Transaction table", complexity = Complexity.MEDIUM)
public class AttendenceSummaryRepositoryImpl extends SearchInterfaceImpl implements AttendenceSummaryRepository<AttendenceSummary> {
    ...
    public List<AttendenceSummary> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.humanresourceboundedcontext.attendance.AttendenceSummary> query = emanager.createQuery("select u from AttendenceSummary u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<AttendenceSummary> save(List<AttendenceSummary> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.humanresourceboundedcontext.attendance.AttendenceSummary obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.humanresourceboundedcontext.attendance.AttendenceSummary s = emanager.find(com.app.shared.humanresourceboundedcontext.attendance.AttendenceSummary.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<AttendenceSummary> findByEmpId(String empId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.humanresourceboundedcontext.attendance.AttendenceSummary> listOfAttendenceSummary = query.getResultList();
    ...
    public AttendenceSummary findById(String attendenceSummaryId) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.humanresourceboundedcontext.attendance.AttendenceSummary listOfAttendenceSummary = (com.app.shared.humanresourceboundedcontext.attendance.AttendenceSummary) query.getSingleResult();
            return listOfAttendenceSummary;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
