...
public class JobTypeRepositoryImpl extends SearchInterfaceImpl implements JobTypeRepository<JobType> {
    ...
    public List<JobType> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.humanresourceboundedcontext.employee.JobType> query = emanager.createQuery("select u from JobType u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<JobType> save(List<JobType> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.humanresourceboundedcontext.employee.JobType obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.humanresourceboundedcontext.employee.JobType s = emanager.find(com.app.shared.humanresourceboundedcontext.employee.JobType.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Transactional
    public JobType findById(String jobTypeCode) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("JobType.findById");
            query.setParameter("jobTypeCode", jobTypeCode);
            com.app.shared.humanresourceboundedcontext.employee.JobType listOfJobType = (com.app.shared.humanresourceboundedcontext.employee.JobType) query.getSingleResult();
    ...
    @Transactional
    public List<JobType> JobtypeNQ() throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("JobtypeNQ");
            List<JobType> listOfJobType = query.getResultList();
            return listOfJobType;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
    ...
    @Transactional
    public List<JobType> TestOne() throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("TestOne");
            List<JobType> listOfJobType = query.getResultList();
            return listOfJobType;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
    ...
    @Transactional
    public List<JobType> TestTwo() throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("TestTwo");
            List<JobType> listOfJobType = query.getResultList();
            return listOfJobType;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
