package com.app.server.businessservice.humanresourceboundedcontext.employee.aspect;
...
public class BusinessServiceemployeeAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.app.server.businessservice.humanresourceboundedcontext.employee..*(..))")
