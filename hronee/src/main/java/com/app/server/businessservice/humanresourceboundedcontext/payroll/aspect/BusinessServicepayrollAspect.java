package com.app.server.businessservice.humanresourceboundedcontext.payroll.aspect;
...
public class BusinessServicepayrollAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.app.server.businessservice.humanresourceboundedcontext.payroll..*(..))")
