package com.app.server.businessservice.humanresourceboundedcontext.attendance.aspect;
...
public class BusinessServiceattendanceAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.app.server.businessservice.humanresourceboundedcontext.attendance..*(..))")
