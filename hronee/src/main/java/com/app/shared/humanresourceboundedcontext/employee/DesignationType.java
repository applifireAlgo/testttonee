...
@SourceCodeAuthorClass(createdBy = "anagha.kulkarni@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "DesignationType", complexity = Complexity.LOW)
@NamedQueries({ @javax.persistence.NamedQuery(name = "DesignationType.DefaultFinders", query = "select e from DesignationType e where e.systemInfo.activeStatus=1 and e.designatnTypeDesc LIKE :designatnTypeDesc"), @javax.persistence.NamedQuery(name = "DesignationType.findById", query = "select e from DesignationType e where e.systemInfo.activeStatus=1 and e.designatnTypeCode =:designatnTypeCode") })
public class DesignationType implements Serializable, CommonEntityInterface, Comparator<DesignationType> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.humanresourceboundedcontext.employee.DesignationType other = (com.app.shared.humanresourceboundedcontext.employee.DesignationType) obj;
            if (designatnTypeCode == null) {
                return false;
