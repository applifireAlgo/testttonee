...
@SourceCodeAuthorClass(createdBy = "anagha.kulkarni@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "DepartmentType", complexity = Complexity.LOW)
@NamedQueries({ @javax.persistence.NamedQuery(name = "DepartmentType.DefaultFinders", query = "select e from DepartmentType e where e.systemInfo.activeStatus=1 and e.deptTypeDesc LIKE :deptTypeDesc"), @javax.persistence.NamedQuery(name = "DepartmentType.findById", query = "select e from DepartmentType e where e.systemInfo.activeStatus=1 and e.deptTypeCode =:deptTypeCode") })
public class DepartmentType implements Serializable, CommonEntityInterface, Comparator<DepartmentType> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.humanresourceboundedcontext.employee.DepartmentType other = (com.app.shared.humanresourceboundedcontext.employee.DepartmentType) obj;
            if (deptTypeCode == null) {
                return false;
